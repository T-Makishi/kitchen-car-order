...
export function CustomerApp() {
  ...
  return <>
    ...
    <main id="main">
      ...
      <section className="section story-section" id="story"><div className="shell story-grid"><div><p className="eyebrow">OUR STORY</p><h2 className="story-catch"><span>小さいからこそ</span><em>ていねいに。</em></h2></div><div><p>朝のやさしいごはん、気軽に楽しめる丼や軽食、季節のドリンク。いつもの町に、小さな楽しみを運びます。</p><p className="story-note">ORDER AHEAD · PICK UP · PAY WITH SQUARE</p></div></div></section>
